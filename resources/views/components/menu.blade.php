...
<nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
				<a class="navbar-brand" href="{{ url('/') }}"><img src="https://static.wixstatic.com/media/063a76_c241df48416b4516bf45c27115fee2f0~mv2.png/v1/fill/w_170,h_50,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/techshop-logo.png" alt="">
                </a>
				<!-- hamburguer button -->
                            ...
                            <li class="nav-item dropdown">
								...
								<div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
									...
									<a class="dropdown-item" href="{{ route('logout') }}"
									   ...
									   submit();"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-box-arrow-right me-1" viewBox="0 0 16 16">
